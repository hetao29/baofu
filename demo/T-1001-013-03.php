...
/**
 * 宝付账簿 - 开户查询接口
 * https://doc.mandao.com/docs/bct/queryAcc
 */
...
$HeaderPost["serviceTp"] = "T-1001-013-03"; //报文编号
...
$BodyData["platformNo"] = $GLOBALS["Member_Id"]; //平台号(主商户号) 

$BodyData["loginNo"] = "LN17464143403681"; //登录号(传此参数以上三个参数必填)
//$BodyData["certificateType"] = "ID";//证件类型 只能取”ID”个人或”LICENSE”企业
//$BodyData["certificateNo"] = "340102200001010458";//证件号码/社会信用代码

$BodyData["contractNo"] = ""; //客户账户号(传此参数以上四个参数可以不填)
